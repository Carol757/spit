...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(networkData) {
      ...
      const diviCount = await dstorage.methods.diviCount().call()
      this.setState({ diviCount })
    ...
    //  this.setState({ all : all[this.state.account]})
      ...
      this.setState({
        ...
        this.setState({
          ...
          const d = await dstorage.methods.d(this.state.account).call()
          this.setState({
            d: [...this.state.all, d]
          })
      ...
      for (var i = diviCount; i >= 1; i--) {
        const dividend = await dstorage.methods.dividends(i).call()
        this.setState({
          dividends: [...this.state.dividends, dividend]
        })
            ...
            div = ()  => {
              ...
              //  console.log("Submitting file to IPFS...")
                ...
                // Add file to the IPFS
                  ...
                  this.state.dstorage.methods.div().send({ from: this.state.account }).on('transactionHash', (hash) => {
              ...
              div1 = ()  => {
                ...
                //  console.log("Submitting file to IPFS...")
                  ...
                  // Add file to the IPFS
                    ...
                    this.state.dstorage.methods.div1().send({ from: this.state.account }).on('transactionHash', (hash) => {
